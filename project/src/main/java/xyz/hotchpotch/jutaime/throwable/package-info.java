 ...
 * 各種 {@code Matcher} を組み合わせて使用することにより、任意の例外およびエラーをスローしうるオペレーションを
 ...
 * </pre>
 * <br>
 * また、{@link org.hamcrest.CoreMatchers} が提供する標準 {@code Matcher} と組み合わせて使用することもできます。<br>
 ...
 *         allOf(raise(WrappingException.class), rootCause(RuntimeException.class), not(rootCause(NullPointerException.class))));
 * </pre>
 * {@link org.hamcrest.CoreMatchers#allOf(org.hamcrest.Matcher...) allOf()} の代わりに次のスタイルで記述することも可能です。<br>
 * <pre>
 * assertThat(of(() {@code ->} obj.doSomething(param)),
 *         raise(WrappingException.class).rootCause(RuntimeException.class).not(rootCause(NullPointerException.class)));
 * </pre>
 * 
