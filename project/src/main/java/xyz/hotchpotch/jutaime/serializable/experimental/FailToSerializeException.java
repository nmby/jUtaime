 ...
 * 
 * @deprecated このクラスは {@link xyz.hotchpotch.jutaime.serializable.FailToSerializeException
 *                            xyz.hotchpotch.jutaime.serializable.FailToSerializeException} として正式リリースされました。<br>
